<?php
    ...
    mysqli_query($conexion,"INSERT INTO `course` (`name`, `description`, `link`, `prices`, `status`, `available_date`, `available_time`) VALUES ('$_POST[name]', '$_POST[description]', '$_POST[link]', '$_POST[prices]', 'true', '$_POST[available_date]', '$_POST[available_time]');") or die("Problemas en el select".mysqli_error());
