...
<body>
	...
	<form action="testenvio.php" method="post">
		<div class="wrapper">
	...
	<div class="wrapper">
		<h5>Dejanos tus comentarios</h5>
			...
			<div class="btn-group">
				...
				<button type="button"  class="btn cancel" onclick="redirigir()">Cancelar</button>
			</div>
		</div>
	</form>
...
function print_facture() {
    ...
    var docDefinition = {
        content: [
            ...
            { text: 'Pregunta 1: ' + valorUno },
            { text: 'Pregunta 2: ' + valorDos },
            { text: 'Pregunta 3: ' + valorTres },
            { text: 'Pregunta 4: ' + valorCuatro },
            { text: 'Pregunta 5: ' + valorCinco },
            { text: 'Pregunta 6: ' + valorSeis },
            { text: 'Pregunta 7: ' + valorSiete },
            { text: 'Pregunta 8: ' + valorOcho },
            { text: 'Pregunta 9: ' + valorNueve },
            { text: 'Pregunta 10: ' + valorDiez },
            { text: 'Pregunta 11: ' + valorOnce },
            { text: 'Pregunta 12: ' + valorDoce },
            { text: 'Pregunta 13: ' + valorTrece }
        ],
        styles: {
            header: {
                fontSize: 18,
